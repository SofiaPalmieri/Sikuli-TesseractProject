...
class Builder:
        ...
        for target in alltargets:
            ...
            if xcode_ver >= 7 and target[1] == 'Catalyst':
                ...
                c_flags = [
                    ...
                    "-isysroot %s" % sdk_path,
                    "-iframework %s/Pickled/iOSSupport/Pickled/Library/Frameworks" % sdk_path,
                    "-isystem %s/Pickled/iOSSupport/usr/include" % sdk_path,
                ]
    ...
    def makeDynamicLib(self, builddir):
        ...
        if target_platform == "catalyst":
            ...
            framework_options = [
                "-iframework", "%s/Pickled/iOSSupport/Pickled/Library/Frameworks" % sdk_dir,
